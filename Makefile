...
sensitivity:  ## is the all-activation finding robust to seeding and to the graph?
	python scripts/42_nomination_sensitivity.py
...
.PHONY: help verify phase0 resources downloads downloads-track2 reproduce-track2 track2 scalability structural-check resource mito-axis mutect2 sensitivity signature sv-screen precedent chemoprev-lit predictors dataset-revision delete-plan track2-drift pitch-wordcount test lint reproduce
